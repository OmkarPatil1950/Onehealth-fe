...
function Profile() {
  ...
  //     try {
  //       const response = await ProfileService.getProfile(103  );
...
// import PhoneInput from 'react-phone-input-2';
// import 'react-phone-input-2/lib/style.css';
// import { add } from '../components/store/profileSlice';
// import ProfileService from '../Service/ProfileService';
...
//   useEffect(() => {
//     // Fetch profile data and set initial form state...
//   }, []);
...
//   // Define handleChange functions for each field
//   const handlefirst_nameChange = (event) => {
//     setfirst_name(event.target.value);
//     validateField('first_name', event.target.value);
//   };

//   const handlelast_nameChange = (event) => {
//     setlast_name(event.target.value);
//     validateField('last_name', event.target.value);
//   };
...
//     validateField('gender', event.target.value);
//   };

//   const handleBloodGroupChange = (event) => {
//     setBloodGroup(event.target.value);
//     validateField('blood_group', event.target.value);
//   };

//   const handleSpecializationChange = (event) => {
//     setSpecialization(event.target.value);
//     validateField('specialization', event.target.value);
//   };
...
//         validateField('birth_date', formattedDate);
//         break;
//       case 'license_expiry_date':
//         setLicenseExpiryDate(formattedDate);
//         validateField('license_expiry_date', formattedDate);
//         break;
...
//                         id="gender"
//                         name="gender"
//                         value={gender} // Make sure this value matches one of the options in the dropdown
